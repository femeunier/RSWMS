...
MODULE ParamData
  ...
  INTEGER(ap),PARAMETER :: maxgrw=50000,maxrec=200000,maxest=5000
  INTEGER(ap),PARAMETER :: maxemg=250,maxord=3,maxmat=10,maxbnd=19
...
MODULE RootData
  ...
  INTEGER(ap) :: naxes,norder,seed,ntimeobs
...
MODULE DoussanMat
  ...
  INTEGER(ap) :: nBCn,nKh(1:3),nLr(1:3),nmax,nrecOld,isubmax=100,nplant=1,solveroot_call=0
